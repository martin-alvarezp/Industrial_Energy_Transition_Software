...
export default function Cockpit({ result, reference, referenceLabel, bauFeasible, config, source }) {
...
function FeasibleCockpit({ result, reference, referenceLabel, bauFeasible, config, source }) {
